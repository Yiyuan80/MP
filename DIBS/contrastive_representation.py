...
def contra_representation(model):
    ...
    contra_rep.to_csv('/home/DHE/yy289/PACE_Home_Drive/yiyuan/contra_representation.csv')
    return contra_rep
...
new_model =  keras.models.load_model('/home/DHE/yy289/PACE_Home_Drive/my_model-20220224T055709Z-001/my_model')
